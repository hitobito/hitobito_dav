...
unless QualificationKind.exists?
  ...
  QualificationKind::Translation.seed_once(:qualification_kind_id, :locale,
    ...
    {qualification_kind_id: 11, locale: "de", label: "DAV  Aspirant*in - Tourenleiter*in"},
    {qualification_kind_id: 12, locale: "de", label: "DAV Tourenleiter*in 1 Sommer"},
    {qualification_kind_id: 13, locale: "de", label: "DAV Tourenleiter*in 1 Sommer Senioren"},
    {qualification_kind_id: 14, locale: "de", label: "DAV Tourenleiter*in 1 Winter"},
    {qualification_kind_id: 15, locale: "de", label: "DAV Tourenleiter*in 1 Winter Schneeschuhe"},
    {qualification_kind_id: 16, locale: "de", label: "DAV Tourenleiter*in 1 Winter Senioren"},
    {qualification_kind_id: 17, locale: "de", label: "DAV Tourenleiter*in 2 Sommer"},
    {qualification_kind_id: 18, locale: "de", label: "DAV Tourenleiter*in 2 Winter"},
    {qualification_kind_id: 19, locale: "de", label: "DAV Tourenleiter*in Alpinwandern"},
    {qualification_kind_id: 20, locale: "de", label: "DAV Tourenleiter*in Bergwandern"},
    {qualification_kind_id: 21, locale: "de", label: "DAV Tournleiter*in Mountainbike"}, # Typo required for import
    {qualification_kind_id: 22, locale: "de", label: "DAV Tourenleiter*in Sportklettern *"}, # * required for import
