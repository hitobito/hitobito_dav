...
unless SelfRegistrationReason.exists?
  ...
  SelfRegistrationReason::Translation.seed_once(:self_registration_reason_id, :locale,
    ...
    {self_registration_reason_id: 7, locale: "de", text: "Wegen den vergünstigten Übernachtungen in den DAV-Hütten."},
    {self_registration_reason_id: 8, locale: "de", text: "Wegen den vergünstigten Angeboten (DAV-Führer, DAV-Tourenportal, Club-Shop, etc.)."},
