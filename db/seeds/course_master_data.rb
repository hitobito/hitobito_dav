...
def seed_cost_centers
  ...
  CostCenter::Translation.seed_once(:cost_center_id, :locale,
    ...
    {cost_center_id: cost_centers.fetch("10000"), locale: "de", label: "Nicht Aktiv"})
end
...
def seed_cost_units
  ...
  CostUnit::Translation.seed_once(:cost_unit_id, :locale,
    {cost_unit_id: cost_units.fetch("A0000"), locale: "de", label: "Nicht Aktiv"},
    ...
    {cost_unit_id: cost_units.fetch("A1500"), locale: "de", label: "DAV - Leiterausbildung Winter"},
    {cost_unit_id: cost_units.fetch("A2000"), locale: "de", label: "DAV - Leiterfortbildung Winter"},
    ...
    {cost_unit_id: cost_units.fetch("A6000"), locale: "de", label: "DAV - Leiterausbildung Sommer"},
    {cost_unit_id: cost_units.fetch("A6500"), locale: "de", label: "DAV - Leiterfortbildung Sommer"},
    ...
    {cost_unit_id: cost_units.fetch("A7200"), locale: "de", label: "DAV - Lager Kinder- und Familienbergsteigen"},
    {cost_unit_id: cost_units.fetch("A7300"), locale: "de", label: "DAV - Jugend"},
    {cost_unit_id: cost_units.fetch("A7400"), locale: "de", label: "DAV - Leistungssport"},
    {cost_unit_id: cost_units.fetch("A8000"), locale: "de", label: "DAV - Tourenangebote Winter"},
    {cost_unit_id: cost_units.fetch("A8500"), locale: "de", label: "DAV - Tourenangebote Sommer"},
    {cost_unit_id: cost_units.fetch("A9000"), locale: "de", label: "DAV - Hüttenwartsausbildung"},
    {cost_unit_id: cost_units.fetch("A9100"), locale: "de", label: "DAV - Kurskaderausbildung"},
    {cost_unit_id: cost_units.fetch("A9500"), locale: "de", label: "DAV - Sektionen"})
end
...
def seed_event_kind_categories
  ...
  Event::KindCategory::Translation.seed_once(:event_kind_category_id, :locale,
    ...
    {event_kind_category_id: kind_categories.fetch(1500), locale: "de", label: "DAV - Leiterausbildung Winter"},
    {event_kind_category_id: kind_categories.fetch(2000), locale: "de", label: "DAV - Leiterfortbildung Winter"},
    ...
    {event_kind_category_id: kind_categories.fetch(6000), locale: "de", label: "DAV - Leiterausbildung Sommer"},
    {event_kind_category_id: kind_categories.fetch(6500), locale: "de", label: "DAV - Leiterfortbildung Sommer"},
    ...
    {event_kind_category_id: kind_categories.fetch(7200), locale: "de", label: "DAV - Lager Kinder- und Familienbergsteigen"},
    {event_kind_category_id: kind_categories.fetch(7300), locale: "de", label: "DAV - Jugend"},
    {event_kind_category_id: kind_categories.fetch(7400), locale: "de", label: "DAV - Leistungssport"},
    {event_kind_category_id: kind_categories.fetch(8000), locale: "de", label: "DAV - Tourenangebote Winter"},
    {event_kind_category_id: kind_categories.fetch(8500), locale: "de", label: "DAV - Tourenangebote Sommer"},
    {event_kind_category_id: kind_categories.fetch(9000), locale: "de", label: "DAV - Hüttenwartsausbildung"},
    {event_kind_category_id: kind_categories.fetch(9100), locale: "de", label: "DAV - Kurskaderausbildung"},
...
def seed_event_levels
  ...
  Event::Level::Translation.seed_once(:event_level_id, :locale,
    {event_level_id: levels.fetch(1), locale: "de", label: "DAV-Einführungskurs", description: "DAV-Einführungskurse ermöglichen das Schnuppern von Bergluft und erste Erlebnisse in Fels, Schnee und Eis. Es sind keine Vorkenntnisse notwendig, der Bergführer zeigt dir alles von Grund auf. Du bist danach bestens auf die Teilnahme an einfachen Sektionstouren vorbereitet."},
    {event_level_id: levels.fetch(2), locale: "de", label: "DAV-Grundausbildungskurs", description: "In DAV-Grundausbildungskursen verbesserst du deine Kenntnisse in der gewählten Bergsportart. Erste Erfahrungen in der jeweiligen Disziplin sind deshalb erforderlich. Diese hast du z. B. in einem DAV-Einführungskurs und danach auf DAV-Sektionstouren erworben. Routinierte Bergführerinnen fördern deine Selbstständigkeit in der Planung und Durchführung von Bergtouren. Einfachere private oder mittelschwere Touren mit der Sektion sind anschliessend kein Problem mehr."},
    {event_level_id: levels.fetch(3), locale: "de", label: "DAV-Fortbildungskurs", description: "DAV-Fortbildungskurse bieten Gelegenheit, dein bisheriges Know-how im Bergsport zu vertiefen. Du gewinnst an Selbstständigkeit und Sicherheit. Du beherrschst die alpinen Grundkenntnisse und kannst eine solide Tourenpraxis aufweisen. Diese hast du z.?B. in einem DAV-Grundausbildungskurs und danach auf privaten und DAV-Sektionstouren erworben. Mittelschwere private oder anspruchsvolle Touren mit der Sektion sind anschliessend kein Problem mehr."},
    {event_level_id: levels.fetch(4), locale: "de", label: "DAV-Leiterausbildung", description: "DAV-Tourenleiterkurse ermöglichen dir den Erwerb und Ausbau von Führungskompetenz, welche du unter anderem für das künftige Leiten von DAV-Sektionstouren benötigst. Erfahrung als Seilschaftsführer auf selbstständig durchgeführten Touren (mit dem Niveau der erwähnten Vergleichstouren) ist unerlässlich. In diesen Kursen wird das Können der Kursteilnehmenden überprüft."},
    {event_level_id: levels.fetch(5), locale: "de", label: "DAV-Leiterfortbildung", description: "Verschiedene DAV-Tourenleiterfortbildungskurse ermöglichen dir, dich als aktive DAV-Tourenleiterin weiterzubilden und der Fortbildungspflicht nachzukommen."},
