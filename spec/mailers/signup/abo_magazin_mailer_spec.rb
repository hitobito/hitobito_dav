...
describe Signup::AboMagazinMailer do
  ...
  it "sends confirmation email" do
    ...
    expect(body).to include('Ich habe die <a href="https://www.alpenverein.de/de/meta/agb/die-alpen/">AGB</a> ' \
      "gelesen und stimme diesen zu.<br>")
    expect(body).to include('Ich habe die <a href="https://www.alpenverein.de/de/meta/datenschutz">Datenschutzerklärung</a> ' \
      "gelesen und stimme diesen zu.<br>")
