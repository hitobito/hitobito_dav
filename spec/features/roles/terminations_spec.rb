...
describe :roles_terminations, js: true do
  ...
  it "displays disabled button with tooltip when current_user is abonnent" do
    ...
    expect(page).to have_css('div[rel="tooltip"][title="Eine Kündigung kann nur über den Mitgliederdienst des DAV erfolgen. Bitte schreibe eine E-Mail mit dem gewünschten Kündigungstermin sowie deinem Vor- und Nachnamen an info@alpenverein.de."]')
  end
end
